...
If `--save` is specified during training, an HDF5 file of the model's layers and weights will be saved. This file can be directly used for additonal training and inferencing.
